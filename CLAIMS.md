...
|---|---|---|---|
| Synthetic data alone protects against membership inference | ⚔️ contested | DP-guaranteed synthesis: [Tab-PE — Differentially Private Synthetic Tabular Data via Private …](https://openreview.net/forum?id=SPgqHr2jiK) · [Minimax optimal differentially private synthetic data for smooth qu…](http://arxiv.org/abs/2602.01607v3) | [Finding Connections](http://arxiv.org/abs/2602.07126v2) — MIA succeeds in multi-table settings |
